...
public class CommentControllerTest {
    ...
    public void shouldReturn400WhenGetComments() {
        url = "http://localhost:"+port+"/chat/1/comments?sort=hot";
    ...
    public void shouldReturn404WhenGetComments() {
        url = "http://localhost:"+port+"/chat/1/comments?sort=date&start=0&count=10";
        ...
        //返回评论的总数
        when(commentService.count("chat",1)).thenReturn(0);
    ...
    /**
     * 获取话题评论，用户未登录，应该返回200和1条评论，评论有1条回复，没有评论图片
     */
    @Test
    public void shouldReturn200WhenGetComments() {
        ...
        //返回评论的总数
        when(commentService.count("chat",1)).thenReturn(1);
        ...
        //返回评论
        when(commentService.getList(0, 10, "date", "chat", 1)).thenReturn(comments);
    ...
    /**
     * 获取话题评论，用户登录，应该返回200和1条评论，评论有1条回复，包含评论图片
     */
    @Test
    ...
    public void shouldReturn401WhenCreateComment() {
        url = "http://localhost:"+port+"/chat/1/comment";
    ...
    public void shouldReturn500WhenCreateComment() {
        ...
        //返回话题
        when(chatService.findByID(1)).thenReturn(new Chat());
    ...
    public void shouldReturn401WhenCreateReply() {
        url = "http://localhost:"+port+"/chat/1/comment/1";
