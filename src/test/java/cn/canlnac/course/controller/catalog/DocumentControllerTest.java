...
public class DocumentControllerTest {
    ...
    public void shouldReturn401WhenCreateDocument() {
        url = "http://localhost:"+port+"/catalog/1/document";
    ...
    public void shouldReturn401WhenGetDocuments() {
        url = "http://localhost:"+port+"/catalog/1/documents";
    ...
    public void shouldReturn400WhenGetDocuments() {
        url = "http://localhost:"+port+"/catalog/1/documents?start=0&count=10&sort=sizes";
    ...
    public void shouldReturn404WhenGetDocuments() {
        url = "http://localhost:"+port+"/catalog/1/documents?start=0&count=10&sort=size";
        ...
        when(documentService.count("catalog",1,null)).thenReturn(0);  //统计文档数目
    ...
    public void shouldReturn200WhenGetDocuments() {
        ...
        when(documentService.count("catalog",1,null)).thenReturn(1);  //统计文档数目
        //获取文档
        Document document = new Document();
        List<Document> documents = new ArrayList();
        documents.add(document);
        when(documentService.getDocuments(0,10,"size","catalog",1,null)).thenReturn(documents);
